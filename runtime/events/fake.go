...
// FakeRecorder implements the Recorder interface.
var _ Recorder = &FakeRecorder{}
...
// functionality. The recorder will implement the Recorder interface but
...
// kind and (group) API version set. When includeObject is false it returns an
// empty reference, so recorded events will carry no name or namespace and will
// not match name/namespace filters (e.g. testenv.GetEvents).
