...
// NewRecorder creates an EventRecorder with a Kubernetes event recorder and an
...
func NewRecorder(log logr.Logger, webhook, reportingController string, opts ...RecorderOption) (EventRecorder, error) {
	if webhook != "" {
