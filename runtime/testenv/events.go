...
// It returns an error if listing events from the client fails.
func GetEvents(ctx context.Context, client client.Client, objName, namespace string, annotations map[string]string) ([]eventsv1.Event, error) {
